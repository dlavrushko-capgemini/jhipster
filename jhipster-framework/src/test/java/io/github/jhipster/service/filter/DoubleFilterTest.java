...
public class DoubleFilterTest {
    ...
    @Test
        public void testEquals() {
            final DoubleFilter filter2 = new DoubleFilter();
            ...
            assertThat(filter).isEqualTo(filter2);
            final DoubleFilter filter3 = new DoubleFilter();
    ...
    @Test
        public void testSetNotEquals() {
            Filter<Double> chain = filter.setNotEquals(value);
            assertThat(chain).isEqualTo(filter);
    ...
    @Test
        public void testToString() {
            ...
            assertThat(filter.toString()).isEqualTo("DoubleFilter [equals=" + str + ", notEquals=" + str + ", specified=true, in=[], notIn=[], greaterThan=" + str + ", lessThan=" + str + ", greaterThanOrEqual=" + str + ", lessThanOrEqual=" + str + "]");
        }
}