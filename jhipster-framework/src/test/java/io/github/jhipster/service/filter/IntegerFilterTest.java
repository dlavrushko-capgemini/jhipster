...
public class IntegerFilterTest {
    ...
    public void testToString() {
        ...
        assertThat(filter.toString()).isEqualTo("IntegerFilter [equals=" + str + ", notEquals=" + str + ", specified=true, in=[], notIn=[], greaterThan=" + str + ", lessThan=" + str + ", greaterThanOrEqual=" + str + ", lessThanOrEqual=" + str + "]");
    }
}