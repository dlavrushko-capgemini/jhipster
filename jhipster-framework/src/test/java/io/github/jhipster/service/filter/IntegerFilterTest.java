...
public class IntegerFilterTest {
    ...
    @Test
        public void testToString() {
            ...
            assertThat(filter.toString()).isEqualTo(String.format("IntegerFilter [equals=%s, notEquals=%s, specified=true, in=[], notIn=[], greaterThan=%s, lessThan=%s, greaterThanOrEqual=%s, lessThanOrEqual=%s]", str, str, str, str, str, str));
        }
}